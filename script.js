...
function submitReport() {
    const url =
        "https://maps.googleapis.com/maps/api/geocode/json?address=1600+Amphitheatre+Parkway,+Mountain+View,+CA&key=AIzaSyBpmyoKedBUoX6w6iuXGdikk-vw3Jlb0cA";
    fetch(url).then(data => {
        console.log(data);
    });
}
...
async function tryLogin() {
    var object = {};
    object["csrf_key"] =
        '4#yr..~%hN%o17oJ-jg%"$-)W#V1%Z2XLZzd6z8maI^mA]*]2t.FyklY8(!KM';
